...
class Result extends Component {
    ...
    render() {
        ...
        return (
            <div className='result' onClick={this.props.handleClick} isFavorite={this.state.isFavorite}>
                ...
                <ResultFavorite url={this.props.url}
                    nature_option={this.props.nature_option}
                    speciesID={this.props.speciesID}

                    name={this.props.name}
                    common={this.props.common} isFavorite={this.state.isFavorite} className='favoriteResult' onClick={this.props.handleClick} >Favorite <span>⭐</span>
                </ResultFavorite>
            </div>
        )
    }
